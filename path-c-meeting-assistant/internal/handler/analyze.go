...
// HandleAnalyze handles POST /api/analyze requests
func HandleAnalyze(c *classifier.Classifier) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := c.Analyze(r.Context(), req)
		if err != nil {
			log.Printf("Error analyzing meeting: %v", err)
